...
class UpdateMavenWrapperTest {
    ...
    @Test
    void apply(@TempDir Path tempDir) throws Exception {
    ...
    @Test
    void applyOtherMavenVersion(@TempDir Path tempDir) throws Exception {
        Path fileFolder = tempDir.resolve(".mvn").resolve("wrapper");
        Files.createDirectories(fileFolder);
        Path filePath = fileFolder.resolve("maven-wrapper.properties");
    ...
    @Test
    void replaceOnlyMavenVersion(@TempDir Path tempDir) throws Exception {
        Path fileFolder = tempDir.resolve(".mvn").resolve("wrapper");
        Files.createDirectories(fileFolder);
        Path filePath = fileFolder.resolve("maven-wrapper.properties");
        Files.writeString(filePath, """
