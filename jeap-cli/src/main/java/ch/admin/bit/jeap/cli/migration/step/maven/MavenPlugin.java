...
public enum MavenPlugin {
    ...
    /**
     * Returns the fully qualified plugin goal reference for use in Maven command lines.
     * For versioned plugins: "groupId:artifactId:version:goal" (e.g., "org.codehaus.mojo:versions-maven-plugin:2.19.1:update-parent")
    ...
    public String goal(String goal) {
        if (version != null) {
            return groupId + ":" + artifactId + ":" + version + ":" + goal;
        }
